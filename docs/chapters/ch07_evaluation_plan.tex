...
\begin{itemize}
  ...
  \item proof-obligation extraction accuracy;
  \item backend routing correctness for symbolic, logical, numeric, and unsupported obligations;
  \item counterexample success when a claim is false;
  \item correct classification of \emph{unknown}, \emph{not encodable}, timeout, and unavailable-backend cases;
...
\begin{itemize}
  ...
  \item fraction of extracted proof obligations certified, refuted, or explicitly left inconclusive;
...
\begin{itemize}
  ...
  \item proof-obligation checks that certify trivial equalities, refute simple false identities, preserve assumptions, and report unavailable or not-encodable backends conservatively;
