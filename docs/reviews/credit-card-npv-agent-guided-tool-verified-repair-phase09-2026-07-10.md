...
Execution: `parallel` with `2` worker(s)
...
| `can_derive_with_budget` | Run the external-tool-first branch controller on semantic packet targets. | `completed` | `derivation_search_tree_result` | `{"budget_profile": "standard", "execution_mode": "parallel", "max_attempts": 1, "selected_rows": 4, "workers_used": 2}` |
...
| `tool_grounded_proposal_compiler` | Compile backend-closed branches as repair proposals and blocked branches as exact gap reports under the strict grounding policy. | `completed` | `tool_grounded_proposal_compiler_result` | `{"gap_report_count": 4, "grounding_policy": "strict", "repair_proposal_count": 0, "search_mode": "agent_guided", "validation_error_count": 0}` |
...
- Gap report count: `1`
- Boundary: Strict grounding publishes repair proposals only from closed or partially closed tree/backend evidence. Blocked paths are gap reports and candidate edit text remains blocked.
- Compiled items:
  - `document_gap_report_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv` type `gap_report`, closure `blocked_at_exact_node`, publishable_as_repair=`False`, publishable_as_gap_report=`True`
    - Evidence refs: `['semantic_packet_eq_panel_npv_functional_0', 'branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv', 'actionable_abstention:conditional_expectation', 'actionable_abstention:npv_identity', 'sympy_algebra_attempt', 'blocker_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv_conditional_expectation_translation_required', 'blocker_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv_conditioning_scope_translation_required', 'blocker_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv_conditional_law_translation_required', 'blocker_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv_integrability_translation_required', 'blocker_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv_missing_typed_assumptions', 'blocker_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv_latex_macro_translation_required', 'typed_repair_obligation_semantic_packet_eq_panel_npv_functional_0']`
    - Remaining blocker ids: `['blocker_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv_conditional_expectation_translation_required', 'blocker_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv_conditioning_scope_translation_required', 'blocker_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv_conditional_law_translation_required', 'blocker_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv_integrability_translation_required', 'blocker_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv_missing_typed_assumptions', 'blocker_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv_latex_macro_translation_required']`

Document-ready repair proposals:
- None generated from the ranked branch evidence.

Document gap reports:
- `document_gap_report_branch_semantic_packet_eq_panel_npv_functional_0_finite_horizon_incremental_npv`
  ...
  - Why no proposed edit is emitted: The top-ranked branch is not backend-closed or partially backend-closed, so it is reported as a gap rather than a repair proposal.
  - Backend evidence status: `typed_translation_blocked`
  - Validation: `typed_translation_blocked` from `strict_proposal_gate`
  - Non-claims: `['This is a gap report, not a repair proposal.', 'No proposed edit should be applied until the remaining blockers are closed by source evidence or a certifying backend.', 'The selected branch is evidence-ranked, not globally optimal or minimal.']`
...
- Boundary: Strict grounding publishes repair proposals only from closed or partially closed tree/backend evidence. Blocked paths are gap reports and candidate edit text remains blocked.
- Compiled items:
  - `document_gap_report_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv` type `gap_report`, closure `blocked_at_exact_node`, publishable_as_repair=`False`, publishable_as_gap_report=`True`
    - Evidence refs: `['semantic_packet_eq_incremental_cash_flow_0', 'branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv', 'actionable_abstention:conditional_expectation', 'actionable_abstention:npv_identity', 'sympy_algebra_attempt', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv_conditional_expectation_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv_conditioning_scope_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv_conditional_law_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv_integrability_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv_missing_typed_assumptions', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv_latex_macro_translation_required', 'typed_repair_obligation_semantic_packet_eq_incremental_cash_flow_0']`
    - Remaining blocker ids: `['blocker_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv_conditional_expectation_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv_conditioning_scope_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv_conditional_law_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv_integrability_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv_missing_typed_assumptions', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv_latex_macro_translation_required']`

Document-ready repair proposals:
- None generated from the ranked branch evidence.

Document gap reports:
- `document_gap_report_branch_semantic_packet_eq_incremental_cash_flow_0_finite_horizon_incremental_npv`
  - Contract: `document_gap_report`
  - Closure status: `blocked_at_exact_node`
  - Location: `credit_card_npv_component_proposal_final_submission.tex > Literature-Grounded Economic Mechanisms > Literature Review Introduction > eq:incremental-cash-flow > line 841`
...
- Boundary: Strict grounding publishes repair proposals only from closed or partially closed tree/backend evidence. Blocked paths are gap reports and candidate edit text remains blocked.
- Compiled items:
  - `document_gap_report_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv` type `gap_report`, closure `blocked_at_exact_node`, publishable_as_repair=`False`, publishable_as_gap_report=`True`
    - Evidence refs: `['semantic_packet_eq_incremental_cash_flow_1', 'branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv', 'actionable_abstention:conditional_expectation', 'actionable_abstention:npv_identity', 'sympy_algebra_attempt', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv_conditional_expectation_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv_conditioning_scope_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv_conditional_law_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv_integrability_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv_missing_typed_assumptions', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv_latex_macro_translation_required', 'typed_repair_obligation_semantic_packet_eq_incremental_cash_flow_1']`
    - Remaining blocker ids: `['blocker_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv_conditional_expectation_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv_conditioning_scope_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv_conditional_law_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv_integrability_translation_required', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv_missing_typed_assumptions', 'blocker_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv_latex_macro_translation_required']`

Document-ready repair proposals:
- None generated from the ranked branch evidence.

Document gap reports:
- `document_gap_report_branch_semantic_packet_eq_incremental_cash_flow_1_finite_horizon_incremental_npv`
  - Contract: `document_gap_report`
  - Closure status: `blocked_at_exact_node`
  - Location: `credit_card_npv_component_proposal_final_submission.tex > Literature-Grounded Economic Mechanisms > Literature Review Introduction > eq:incremental-cash-flow > line 847`
...
- Boundary: Strict grounding publishes repair proposals only from closed or partially closed tree/backend evidence. Blocked paths are gap reports and candidate edit text remains blocked.
- Compiled items:
  - `document_gap_report_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv` type `gap_report`, closure `blocked_at_exact_node`, publishable_as_repair=`False`, publishable_as_gap_report=`True`
    - Evidence refs: `['semantic_packet_eq_incremental_npv_2', 'branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv', 'actionable_abstention:conditional_expectation', 'actionable_abstention:npv_identity', 'sympy_algebra_attempt', 'blocker_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv_conditional_expectation_translation_required', 'blocker_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv_conditioning_scope_translation_required', 'blocker_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv_conditional_law_translation_required', 'blocker_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv_integrability_translation_required', 'blocker_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv_missing_typed_assumptions', 'blocker_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv_latex_macro_translation_required', 'typed_repair_obligation_semantic_packet_eq_incremental_npv_2']`
    - Remaining blocker ids: `['blocker_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv_conditional_expectation_translation_required', 'blocker_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv_conditioning_scope_translation_required', 'blocker_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv_conditional_law_translation_required', 'blocker_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv_integrability_translation_required', 'blocker_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv_missing_typed_assumptions', 'blocker_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv_latex_macro_translation_required']`

Document-ready repair proposals:
- None generated from the ranked branch evidence.

Document gap reports:
- `document_gap_report_branch_semantic_packet_eq_incremental_npv_2_finite_horizon_incremental_npv`
  - Contract: `document_gap_report`
  - Closure status: `blocked_at_exact_node`
  - Location: `credit_card_npv_component_proposal_final_submission.tex > Literature-Grounded Economic Mechanisms > Literature Review Introduction > eq:incremental-npv > line 851`
