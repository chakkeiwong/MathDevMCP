...
STATUS_REQUIRED_NON_CLAIM_CODES: dict[str, set[str]] = {
    ...
    "scope_limited_match": {"structural_evidence_not_proof", "scope_limited_evidence_not_proof"},
...
def default_non_claims(*, extra_codes: set[str] | None = None) -> list[dict[str, Any]]:
    ...
    text = {
        ...
        "scope_limited_evidence_not_proof": "Scope-limited code evidence does not prove a function-level mathematical claim.",
